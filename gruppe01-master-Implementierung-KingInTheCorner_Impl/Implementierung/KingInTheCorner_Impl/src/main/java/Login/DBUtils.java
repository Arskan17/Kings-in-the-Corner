...
public class DBUtils {
    ...
    public static void UserRegistrieren (ActionEvent event, String username, String password){
        ...
        try{
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/kitc", "root", "");
            ...
            if(resultSet.isBeforeFirst()){
                ...
                psInsert = connection.prepareStatement("INSERT INTO anmeldung (Name, passwort) VALUES (?,?)");
